module Settings
  class AIDreamInstructionsComponent < SectionComponent
    form_enabled true
    form_scope "ai"
    icon_class "icon-[lucide--moon-star]"
    parent_section :ai
    ...
    def instructions
      ...
      Instruction.global.dreaming.active.ordered.map { { id: it.id, content: it.content } }
    end

    private

    def submitted_instructions
      raw_items = helpers.params.dig(form_object.model_name.param_key, "dreaming_instructions_attributes")
